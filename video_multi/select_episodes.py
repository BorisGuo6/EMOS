...
all_episode_ids = ['5', '15', '17', '19', '20', '23', '26', '43', '52', '54', '56', '60', '68', '69', '70', '75', '77', '80']
...
print(f"{dir_name} 文件夹下未测试的编号 {[num for num in all_episode_ids if str(num) not in (success + fail)]}")
